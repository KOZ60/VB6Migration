    ...
    static class UTL
    {
        ...
        public class OracleDbTypeToTypeDictionary : ConvertDictionary<OracleDbType, Type>
        {
            public OracleDbTypeToTypeDictionary() {
                ...
                Add(OracleDbType.Raw, OracleTypes.OracleBinary);
                Add(OracleDbType.Long, typeof(string));
                Add(OracleDbType.LongRaw, typeof(byte[]));

                Add(OracleDbType.BFile, OracleTypes.OracleBFile);
                Add(OracleDbType.Blob, OracleTypes.OracleBlob);
                Add(OracleDbType.Clob, OracleTypes.OracleClob);
                Add(OracleDbType.NClob, OracleTypes.OracleClob);

                Add(OracleDbType.IntervalDS, OracleTypes.OracleIntervalDS);
                Add(OracleDbType.IntervalYM, OracleTypes.OracleIntervalYM);

                Add(OracleDbType.Ref, OracleTypes.OracleRef);
                Add(OracleDbType.RefCursor, OracleTypes.OracleRefCursor);

                Add(OracleDbType.TimeStamp, OracleTypes.OracleTimeStamp);
                Add(OracleDbType.TimeStampLTZ, OracleTypes.OracleTimeStampLTZ);
                Add(OracleDbType.TimeStampTZ, OracleTypes.OracleTimeStampTZ);
        ...
        public static void Dispose(this DbParameter parameter) {
        ...
        public static SchemaInformation[] CreateSchema(DbDataReader reader) {
        ...
        public static void FillDataTable(DbDataReader reader, DataTable dt, SchemaInformation[] sc, bool blankStrip) {
            dt.BeginLoadData();
            while (reader.Read()) {
                var row = dt.NewRow();
                row.BeginEdit();
