...
namespace OracleInProcServer
{
    public class OraParamArray : OraParameter
    {
        ...
        internal OraParamArray(string name, paramMode IOtype, serverType serverType, int dimension)
            ...
            this.ArrayBindStatus = Array.CreateInstance(OracleTypes.OracleParameterStatus, dimension);
        }
        ...
        protected int[] ArrayBindSize {
            get {
                return Parameter.GetProperty<int[]>("ArrayBindSize");
            }
            set {
                Parameter.SetProperty("ArrayBindSize", value);
            }
        }

        protected Array ArrayBindStatus {
            get {
                return Parameter.GetProperty<Array>("ArrayBindStatus");
            }
            set {
                Parameter.SetProperty("ArrayBindStatus", value);
            }
        }
