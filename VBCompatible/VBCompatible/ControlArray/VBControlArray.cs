...
namespace VBCompatible.ControlArray
{
    ...
    public abstract class VBControlArray : Component, ISupportInitialize
    {
        ...
        protected VBControlArray() {
            indices = new Hashtable();
            controls = new Hashtable();
            controlAddedAtDesignTime = new Hashtable();
        }

        protected VBControlArray(IContainer Container) : this() {
            Container.Add(this);
        ...
        public int Count() {
            return checked((int)this.controls.Count);
        }
